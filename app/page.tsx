        ...
        <div className="container relative z-10 px-4 sm:px-6 lg:px-8 text-center sm:text-left">
          <div className="max-w-3xl mx-auto sm:mx-0">
            <div className="inline-block px-4 py-1 bg-gold-500/20 border border-gold-400 rounded-full text-gold-300 mb-6">
              <p className="text-sm tracking-wide">地域貢献と収益性の両立を実現</p>
            </div>
            
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white leading-tight tracking-tight mb-6">
              インバウンド専門<br />
            ...
            <p className="text-xl sm:text-2xl text-white font-light mb-6 leading-relaxed">
              眠っている不動産資産を<span className="text-gold-400 font-normal">北海道の魅力を伝える拠点</span>に。<br />
              投資としての合理性と地域への貢献を両立させる、<br className="hidden md:block" />
              新しい不動産活用の形をご提案します。
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                href="/contact"
                className="inline-block px-8 py-4 border border-white text-white hover:bg-white hover:text-black transition-all duration-300 text-lg tracking-wide"
              >
                無料相談はこちら
              </Link>
              ...
              <Link 
                href="/about"
                className="inline-block px-8 py-4 bg-white/10 text-white hover:bg-white/20 transition-all duration-300 text-lg tracking-wide"
              >
                私たちの想い
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-0">
              {process.map((step, index) => (
                <div key={index} className="relative">
                  ...
                  {/* ステップカード */}
                  <div className={`bg-white rounded-lg p-8 shadow-md border-t-4 ${index === 0 ? 'border-gold-500' : index === 1 ? 'border-gold-400' : index === 2 ? 'border-gold-300' : 'border-gold-200'} h-full transition-transform hover:translate-y-[-5px] relative`}>
                    {/* ステップ番号バッジ */}
                    <div className="absolute -top-5 left-1/2 transform -translate-x-1/2 w-10 h-10 rounded-full bg-gold-500 flex items-center justify-center text-white font-bold shadow-md">
                      {step.step}
                    </div>
                    
                    {/* ステップ内容 */}
                    <div className="text-center mt-3 space-y-4">
                      <h3 className="text-xl font-medium text-gray-900 mt-2">{step.title}</h3>
                      ...
                      <div className="w-16 h-16 mx-auto bg-gold-50 rounded-full flex items-center justify-center">
                        {index === 0 ? (
                          ...
                          <PieChart className="h-7 w-7 text-gold-500" />
                        ) : index === 2 ? (
                          <Building className="h-7 w-7 text-gold-500" />
                        ) : (
                          <Calendar className="h-7 w-7 text-gold-500" />
                        )}
                      </div>
