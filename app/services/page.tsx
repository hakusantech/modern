      ...
      <div className="min-h-[90vh] bg-white relative">
        <div className="container mx-auto h-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
            {/* Left Content */}
            <div className="flex flex-col justify-center py-20 lg:py-32 pr-0 lg:pr-12">
                ...
                <ol className="inline-flex items-center space-x-2">
                  ...
                  <li>
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-light text-gray-900">サービス</span>
                    </div>
                  </li>
                </ol>
              </nav>
              ...
              <div className="relative mb-6">
                ...
                <div>
                  <span className="text-xs tracking-[0.2em] uppercase font-medium text-gold-600">
                    インバウンドに特化した
                  </span>
                  <h1 className="text-4xl md:text-6xl font-extralight text-gray-900 tracking-tight leading-tight mt-2">
                    民泊と旅館の<span className="text-gold-600">運営代行</span>
                  </h1>
                </div>
              </div>
              
              <p className="text-xl text-gray-600 font-light mb-10 max-w-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-10">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-600 ml-3 text-sm">Airbnb・Booking.comの2つの予約サイト対応</p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-gold-100 flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-gold-600" />
                  </div>
                  <p className="text-gray-600 ml-3 text-sm">世界中24時間対応の宿泊予約</p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-gold-100 flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-gold-600" />
                  </div>
                  <p className="text-gray-600 ml-3 text-sm">ホテル並みのリネン付き清掃サービス</p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-gold-100 flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-gold-600" />
                  </div>
                  <p className="text-gray-600 ml-3 text-sm">日本語と英語のゲストコミュニケーション</p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-gold-100 flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-gold-600" />
                  </div>
                  <p className="text-gray-600 ml-3 text-sm">トラブル対応・レポート作成</p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-gold-100 flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-gold-600" />
                  </div>
                  <p className="text-gray-600 ml-3 text-sm">料金最適化・収益分析サービス</p>
                </div>
              </div>
              ...
              <div className="mt-6">
                <Link 
                  href="/contact" 
                  className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-gold-500 to-gold-400 text-white rounded-md shadow-md hover:shadow-lg transition-all group"
                >
                  <span>無料相談を予約する</span>
        ...
        <div className="lg:hidden relative h-[50vh] mt-6 mb-16">
          <Image
            src="/images/sapporo-modern-bedroom.png"
            alt="札幌の高級感ある民泊物件の一例"
            fill
  ...
  return (
    <section className={`py-24 ${backgroundColor}`}>
      <div className="container mx-auto">
        {subtitle && (
          <div className="mb-2">
            <span className={`text-xs tracking-[0.2em] uppercase font-medium ${subtitleColor}`}>
              {subtitle}
            </span>
          </div>
        )}
...
function ComparisonItem({ item, minpaku, ryokan }: ComparisonItemProps) {
  return (
    <div className="grid grid-cols-12 border-b border-gray-100 py-6">
      <div className="col-span-4 pl-8 text-gray-900">{item}</div>
      <div className="col-span-4 text-center">
        {typeof minpaku === 'boolean' ? (
          ...
          <span className="text-gray-700">{minpaku}</span>
        )}
      </div>
      <div className="col-span-4 text-center">
        {typeof ryokan === 'boolean' ? (
          ...
          <span className="text-gray-700">{ryokan}</span>
        )}
      </div>
    </div>
  )
  ...
  return (
    <LuxuryPageLayout>
      ...
      >
        ...
        <div className="max-w-5xl mx-auto mb-20">
          <div className="border-b border-gray-100 py-16">
            <div className="flex flex-col md:flex-row md:items-center mb-8">
              <h3 className="text-2xl md:text-3xl font-light mb-4 md:mb-0 md:w-1/3">民泊業の特徴</h3>
              <div className="md:w-2/3 md:pl-12 relative">
                <div className="absolute top-0 left-0 w-1 h-12 bg-gold-600 md:left-4"></div>
          ...
          <div className="py-16">
            <div className="flex flex-col md:flex-row md:items-center mb-8">
              <h3 className="text-2xl md:text-3xl font-light mb-4 md:mb-0 md:w-1/3">旅館業の特徴</h3>
              <div className="md:w-2/3 md:pl-12 relative">
                <div className="absolute top-0 left-0 w-1 h-12 bg-gold-600 md:left-4"></div>
                <p className="text-gray-600 md:pl-8">
        ...
        <div className="overflow-hidden border border-gray-200 rounded-lg mb-20 max-w-5xl mx-auto">
          {/* Table Header */}
          <div className="grid grid-cols-12 bg-gray-50 py-6">
            <div className="col-span-4 pl-8 text-gray-600 text-sm font-medium">
              比較項目
            </div>
            <div className="col-span-4 text-center text-gray-600 text-sm font-medium">
              民泊業
            </div>
            <div className="col-span-4 text-center text-gray-600 text-sm font-medium">
              旅館業
          ...
          {professionalServices.map((service) => (
            <div key={service.id} className="bg-white border border-gray-100 group hover:border-gold-200 transition-colors">
              <div className="grid grid-cols-1 md:grid-cols-3">
                <div className="md:col-span-1 relative h-full min-h-[200px] overflow-hidden">
                  <Image
                    src={service.image || "/placeholder.svg"}
                    alt={service.title}
                    fill
      ...
      <LuxurySection backgroundColor="bg-black" textColor="text-white" dividerColor="bg-gold-600">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-light text-white mb-6">サービスに関するお問い合わせ</h2>
          ...
          <Link 
            href="/contact"
            className="inline-block px-10 py-4 border border-gold-600 text-gold-600 hover:bg-gold-600 hover:text-white transition-colors duration-300"
          >
            お問い合わせをする
          </Link>
        </div>
